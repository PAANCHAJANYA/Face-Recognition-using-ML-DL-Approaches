clc;
load pcadb_1; %Loading pcadb.mat file
...
resultimg=imread(sprintf("C:\\Users\\krish\\Desktop\\Krishna Work\\Face Detection and Recognition\\Implementation - PCA\\TrainDB\\Images_1\\ (%d).JPG",indx)); %Getting best matched image
%Plotting Images
subplot(121)
imshow(imgo);
title('Query Face');
